			...
			case 'price_select' :
				...
				if(typeof(obj_child_field.attr('data-cascade-ajax')) !== 'undefined') {
					...
					if((obj_parent_value === false) && !cascade_no_match) {
						...
						obj_child_select.html('<option value="" data-placeholder>' + option_text_no_rows + '</option>').val('');
					...
					obj_child_select.html('<option value="" data-placeholder>' + option_text_loading + '</option>').val('');
