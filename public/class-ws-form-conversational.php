	...
	class WS_Form_Conversational {
		...
		public function parse_query() {
			...
			if($this->form_id === 0) {
				...
				$this->form_id = ((isset($_GET) && isset($_GET['wsf_preview_conversational_form_id'])) ? absint($_GET['wsf_preview_conversational_form_id']) : 0);		// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
			...
			// Skin filter
			add_filter('wsf_skin_id', function($skin_id) { return 'ws_form_conv'; }, 99999, 1);
