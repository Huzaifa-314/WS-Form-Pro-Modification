	...
	class WS_Form_Form extends WS_Form_Core {
		...
		public function schedule_limit($form_object) {
			...
			if(isset($message)) {
				...
				// Build return
				return self::limit_return_message($message_type, $message);
		...
		public function submit_limit($form_object) {
			...
			// Build return
			return self::limit_return_message($submit_limit_message_type, $submit_limit_message);
		}
		...
		public function user_limit($form_object) {
			...
			// Build return
			return self::limit_return_message($user_limit_logged_in_message_type, $user_limit_logged_in_message);
		}

		public function limit_return_message($type, $message) {
