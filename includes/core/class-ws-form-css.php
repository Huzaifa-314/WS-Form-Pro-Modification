<?php
	...
	//_conversational
			...
			if($css_compile && !$force_build) {
				...
				// Apply filters
				$css_return = apply_filters('wsf_get_conversational', $css_return);
		...
		public function build_public_css() {
			...
			if($css_compile) {
				...
				if($upload_dir['error']) { throw new Exception($upload_dir['message']); }
