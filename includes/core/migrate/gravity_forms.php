				...
				'table_record'		=> array(
					...
					'map'	=> array(
						...
						array('source' => 'display_meta', 'type' => 'json', 'map' => array(
							...
							array('source' => 'title', 'type' => 'record', 'destination' => 'label', 'default' => __('New Form', 'ws-form')),
							...
							array('source' => 'enableHoneypot', 'type' => 'meta', 'destination' => 'honeypot', 'lookup' => 'boolean'),

							array('source' => 'limitEntries', 'type' => 'meta', 'destination' => 'submit_limit', 'lookup' => 'boolean'),
							...
							// Logged In
							array('source' => 'requireLogin', 'type' => 'meta', 'destination' => 'user_limit_logged_in', 'lookup' => 'boolean'),
			...
			'field' => array(
				...
				'table_record'		=> array(
					...
					'map'		=> array(
						...
						array('source' => 'isRequired', 'type' => 'meta', 'destination' => 'required', 'lookup' => 'boolean'),
						array('source' => 'isHidden', 'type' => 'meta', 'destination' => 'hidden', 'lookup' => 'boolean'),
						...
						array('source' => 'noDuplicates', 'type' => 'meta', 'destination' => 'dedupe', 'lookup' => 'boolean'),
						array('source' => 'useRichTextEditor', 'type' => 'meta', 'destination' => 'input_type_textarea', 'lookup' => 'boolean'),
						...
						array('source' => 'layoutGridColumnSpan', 'type' => 'meta', 'destination' => 'breakpoint_size_25'),
						array('source' => 'ecommerce_field_id', 'type' => 'meta', 'destination' => 'ecommerce_field_id'),
						array('source' => 'gwreadonly_enable', 'type' => 'meta', 'destination' => 'readonly', 'lookup' => 'boolean'),
					),
					...
					'map_by_type' => array(
						...
						'fileupload'	=>	array(
							...
							array('source' => 'file', 'type' => 'array', 'map' => array(
								...
								array('source' => 'multipleFiles', 'type' => 'meta', 'destination' => 'multiple_file', 'lookup' => 'boolean')
							))
						),
						...
						'checkbox'	=>	array(
							...
							array('source' => 'choices', 'type' => 'meta', 'destination' => 'data_grid_checkbox', 'process' => array(array('process' => 'datagrid_2_column')), 'map' => array(
								...
								array('source' => 'isSelected', 'type' => 'record', 'destination' => 'default', 'lookup' => 'boolean'),
							...
							array('source' => 'enableSelectAll', 'type' => 'meta', 'destination' => 'select_all', 'lookup' => 'boolean')
						),
						...
						'product'		=>	array(
							...
							array('source' => 'disableQuantity', 'type' => 'scratch', 'destination' => 'disable_quantity', 'lookup' => 'boolean'),
			...
			'submission' => array(
				...
				'table_record'		=> array(
					...
					'map'	=> array(
						...
						array('source' => 'is_fulfilled', 'type' => 'meta', 'destination' => 'ecommerce_fulfilled', 'lookup' => 'boolean'),
