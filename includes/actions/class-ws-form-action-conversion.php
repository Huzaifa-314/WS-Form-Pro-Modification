					...
					parent::success(__('Google conversion tag added to queue', 'ws-form'), array(
						...
						array(
							...
							'parse_values' 	=> array(
								...
								'action' 	=> esc_js(WS_Form_Common::parse_variables_process($this->tag_action, $form, $submit)),
								'category' 	=> esc_js(WS_Form_Common::parse_variables_process($this->tag_category, $form, $submit)),
								'label' 	=> esc_js(WS_Form_Common::parse_variables_process($this->tag_label, $form, $submit)),
								'value' 	=> esc_js($value)
							)
						)
					));
		...
		public function config_meta_keys($meta_keys = array(), $form_id = 0) {
			...
			$config_meta_keys = array(
				...
				'action_' . $this->id . '_tag_category'	=> array(
					...
					'select_list'	=>	true,
					'default'		=>	__('Form - #form_label', 'ws-form'),
					'condition'					=>	array(
