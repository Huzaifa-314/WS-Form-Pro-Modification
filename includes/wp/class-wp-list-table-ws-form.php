...
class WP_List_Table_WS_Form {
	...
	public function search_box( $text, $input_id ) {
		...
		?>
<p class="search-box">
	<label class="screen-reader-text" for="<?php esc_attr_e( $input_id ); ?>"><?php echo $text; ?>:</label>
	<input type="search" id="<?php esc_attr_e( $input_id ); ?>" name="s" value="<?php _admin_search_query(); ?>" />
	...
	protected function view_switcher( $current_mode ) {
		?>
		<input type="hidden" name="mode" value="<?php esc_attr_e( $current_mode ); ?>" />
