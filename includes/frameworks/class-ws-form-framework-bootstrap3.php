					...
					'public' => array(
						...
						'field_types'		=> array(
							...
							'file' 	=> array(
								...
								'mask_help_dropzonejs'				=>	'<span id="#help_id" class="#help_class"#attributes>#help#help_append</span>',
								'mask_invalid_feedback_dropzonejs'	=>	'<div id="#invalid_feedback_id" class="#invalid_feedback_class"#attributes>#invalid_feedback</div>'
							),
							'recaptcha' => array(
