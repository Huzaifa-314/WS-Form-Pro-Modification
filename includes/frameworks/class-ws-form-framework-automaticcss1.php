<?php
	...
	//	Framework config: Automatic.css (Coming soon)

	class WS_Form_Config_Framework_Automatic_CSS_1 {
		...
		public static function get_framework_config() {
			...
			return array(
				...
				'name'							=>	__('Automatic.css', 'ws-form'),

				'default'						=>	false,

				'css_file'						=>	'automatic.css',

				'label_positions'				=>	array('default', 'top', 'left', 'right', 'bottom', 'inside'),

				'columns'					=>	array(

					'column_class'			=>	'col-span--#size',
					'column_css_selector'	=>	'.col-span-#size',
					'offset_class'			=>	'grid-column-start-#offset',
					'offset_css_selector'	=>	'.grid-column-start-#offset'
				),
				...
				'tabs' => array(
					...
					'public' => array(
						...
						'mask_single'		=>	'<li class="nav-item" role="presentation"><button type="button" class="nav-link" data-bs-target="#href" data-bs-toggle="tab" role="tab"#attributes>#label</button></li>',
				...
				'sections' => array(
					...
					'public' => array(
						...
						'mask_wrapper'	=> '<div class="grid--#column_count" id="#id" data-id="#data_id">#sections</div>',
				...
				'fields' => array(
					...
					'public' => array(
						...
						'left' => array(
							...
							'mask'							=>	'<div class="grid--#column_count">#field</div>',
							'mask_field_label_wrapper'		=>	'<div class="col-span-#column_width_label col-form-label text-right">#label</div>',
							'mask_field_wrapper'			=>	'<div class="col-span-#column_width_field">#field</div>',
						),
						...
						'right' => array(
							...
							'mask'							=>	'<div class="grid--#column_count">#field</div>',
							'mask_field_label_wrapper'		=>	'<div class="col-span-#column_width_label col-form-label">#label</div>',
							'mask_field_wrapper'			=>	'<div class="col-span-#column_width_field">#field</div>',
						),
						...
						// Masks
						'mask_wrapper' 			=> '#label<div class="grid--#column_count" id="#id" data-id="#data_id">#fields</div>',
