					...
					'public' => array(
						...
						'field_types'		=> array(
							...
							'file' 	=> array(
								...
								'mask_field_label'					=> '<label id="#label_id" for="#id"#attributes>#label</label>',
								'mask_help_dropzonejs'				=>	'<p#attributes>#help#help_append</p>',
								'mask_invalid_feedback_dropzonejs'	=>	'<small data-form-error-for="#id" class="#invalid_feedback_class"#attributes>#invalid_feedback</small>',
