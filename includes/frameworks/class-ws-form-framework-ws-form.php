			...
			return array(
				...
				'tabs' => array(
					...
					'admin' => array(
						...
						'mask_single'		=>	'<li class="wsf-group-tab" data-id="#data_id" title="#label"><a href="#href"><div class="wsf-group-label"><span class="wsf-group-hidden" title="' . __('Hidden', 'ws-form') . '">' . self::get_icon_16_svg('hidden') . '</span><span class="wsf-group-conditional" title="' . __('Conditional Logic', 'ws-form') . '">' . self::get_icon_16_svg('conditional') . '</span><input type="text" value="#label" data-label="#data_id" readonly></div></a></li>'
					),
					...
					'public' => array(
						...
						'field_types'		=> array(
							...
							'file'		=> array(
								...
								'mask_help_dropzonejs'				=>	'<small class="#help_class"#attributes>#help#help_append</small>',
